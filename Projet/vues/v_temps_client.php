...
<div class="titrecentre">Ajout de temps</div>
    ...
        <input type="hidden" name="notify_url" value="http://localhost/sucre/projet/vues/v_traitement_achat.php">
        <input type="hidden" name="client_id" value="<?php echo $_SESSION['Id'] ; ?>">
        <input type="hidden" name="temps" value="<?php echo $_SESSION['Temps'] ; ?>">
        <table align="center">
