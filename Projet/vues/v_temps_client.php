...
<div class="titrecentre">Ajout de temps</div>
    ...
    <form align="center" action="https://www.sandbox.paypal.com/cgi-bin/webscr" method="post" target="_top">
        ...
        <input type="hidden" name="return" value="http://localhost/sucre/projet/vues/v_paiement_valide.php">
        <input type="hidden" name="notify_url" value="http://localhost/sucre/projet/vues/v_validation_paiement.php">
        <table align="center">
