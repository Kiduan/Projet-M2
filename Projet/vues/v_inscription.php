...
<form  method="post" action="controleurs/c_inscription.php?mdp=normal">
<div style="margin: auto; text-align: center; width: 400px;">
    <div id="login">
		...
		<div class="login_interface">
            <div class="administration">Créer un nouveau compte</div>
            ...
            <div class="login-box-field"><input name="email" class="form-login-admin" title="email:" size="30" maxlength="30" required=""></div><br>
            <div class="login-box-name">mot de passe:</div>
            <div class="login-box-field"><input name="mdp1" class="form-login-admin" title="mot de passe:" value="" size="30" required="" maxlength="30" type="password"></div><br>
            <div class="login-box-name">mot de passe:</div>
            <div class="login-box-field"><input name="mdp2" class="form-login-admin" title="mot de passe:" value="" size="30" required="" maxlength="30" type="password"></div><br>
            <div><input class="box_submit" name="submit" value="inscription" type="submit"></div><br><br>     
                </div>
            </div>
		</div>
